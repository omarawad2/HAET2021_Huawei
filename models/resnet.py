...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, dropout=0):
        ...
        self.use_dropout = True if self.training and dropout>0 and dropout<1 else False
...
def ResNet9(dropout=0):
    return ResNet(BasicBlock, [1, 1, 1, 1], dropout=dropout)


def ResNet18(dropout=0):
    return ResNet(BasicBlock, [2, 2, 2, 2], dropout=dropout)


def ResNet34(dropout=0):
